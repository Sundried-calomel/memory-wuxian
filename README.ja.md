...
> **2.4.4 Beta 1:** このプレリリースでは、クラウド同期の並行制御、
> Environment の回復可能なインポート、Incoming キューの進行、ネイティブ
> バージョンの整合性、Windows ランタイム検証を強化します。安定版の自動更新は
> プレリリースを引き続き無視するため、この Beta は明示的なクロスデバイス検証用です。
>
