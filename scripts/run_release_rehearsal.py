        ...
        (
            ...
            [
                ...
                (
                    ...
                    "assert 'self.sync_batch_mode(paths, true, false, false)' in p;"
                    "assert 'self.sync_batch_mode(paths, true, true, false)' in p;"
                    "assert 'store.sync_batch_mode(paths, true, true, true)' in p;"
                    "assert 'sync_succeeded && caught_up' in p;"
                    "assert 'self.source_error_matches(&path, &metadata)' in p;"
                    "assert 'self.record_source_error(&path, &error)?' in p;"
