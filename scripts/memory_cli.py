...
from memory_cli_contract import command_lock_path, command_spec
from memory_cli_parser import build_parser as build_cli_parser
from memory_cli_runtime import run_cli
...
def build_parser() -> argparse.ArgumentParser:
    return build_cli_parser(
        ...
        maintenance_job_kinds=MAINTENANCE_JOB_KINDS,
        semantic_runtime_artifact_id=SEMANTIC_RUNTIME_ARTIFACT_ID,
    )
...
def main(argv: Optional[Sequence[str]] = None) -> int:
    ...
    return run_cli(argv, cli_module=sys.modules[__name__])
